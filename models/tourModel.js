...
const tourSchema = new mongoose.Schema(
  ...
  },
  {
    ...
    // onvert a document to JavaScript Object
...
// USAULLY CALL IT "Pre-save hook"
tourSchema.pre('save', function (next) {
  this.slug = slugify(this.name, { lower: true });
  next();
});

// EMBEDDED USERS IN TOURS
...
// Populate reference data into res data.
tourSchema.pre(/^find/, function (next) {
  this.populate({
    path: 'guides',
    select: '-__v',
